...
func generateTestData(cm *compactorMetrics, base float64) {
	...
	cm.totalPartitionCount.WithLabelValues("aaa").Add(46 * base)
	cm.totalPartitionCount.WithLabelValues("bbb").Add(47 * base)
	cm.totalPartitionCount.WithLabelValues("ccc").Add(48 * base)
